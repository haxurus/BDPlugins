...
| --- | ---: | --- | --- |
| [Lockscreen](./Lockscreen/) | `1.1.1` | Adds a local Discord lockscreen with 4-digit PIN, 6-digit PIN, password or Android-style pattern unlock, including startup and inactivity locking. | None |
...
- [Download Haxurus Lockscreen](https://raw.githubusercontent.com/haxurus/BDPlugins/main/Lockscreen/Lockscreen.plugin.js)
